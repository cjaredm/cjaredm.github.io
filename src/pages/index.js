            ...
            <div id="main">
              <section id="one" className="tiles">
                <article style={{ backgroundImage: `url(${MyShopImg})` }}>
                  ...
                  <Link
                    to="portfolio/my-shop-analytics"
                ...
                <article style={{ backgroundImage: `url(${POSImg})` }}>
                  <header className="major">
                    ...
                    <p>
                      React Native point of sale system made for iOS to be used
                      with clothing resellers. Runway Fashion Exchange is
                      currently working with us as our first user.
                    </p>
                  </header>
                ...
                <article style={{ backgroundImage: `url(${genericDeskImg})` }}>
                  <header className="major">
                    <h3>Dev Blog</h3>
                    <p>
                      This portfolio site began as my first Gatsby Static Blog.
                      I started it on Github Pages and transitioned over to my
                      own custom domain using Netlify.
                    </p>
                  </header>
              ...
              <section id="two">
                <div className="inner">
                  ...
                  <p>
                    ...
                    works. I am a life-time learner with a Bachelor's degree in
                    Philosophy and a Master's degree of Eduction in
                    Instructional Design. I strive to learn how things work
                    while also focusing on functionality and getting work done.
                  </p>
                  <p>
                    My passion is to create value in the world. I am rewarded
                    when I see my work being used, appreciated and built upon. I
                    one day wish to own my own SaaS company that provides tools
                    for small businesses. I dream to hire and train young adults
                    in software development and mentor others seeking the same
                    rewarding career I already have.
                  </p>
